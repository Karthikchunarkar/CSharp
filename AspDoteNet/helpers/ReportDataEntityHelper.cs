namespace helpers ;
 using EntityHelper = store.EntityHelper; using EntityValidationContext = store.EntityValidationContext; using IEntityMutator = store.IEntityMutator; using ReportData = models.ReportData; using ReportDataRow = models.ReportDataRow; using ReportDataRowEntityHelper = helpers.ReportDataRowEntityHelper; using ReportDataSection = models.ReportDataSection; using ReportDataSectionEntityHelper = helpers.ReportDataSectionEntityHelper;  public class ReportDataEntityHelper < T > :  EntityHelper<T> where T : ReportData { private readonly IEntityMutator mutator ;
