namespace helpers ;
 using EntityHelper = store.EntityHelper; using EntityValidationContext = store.EntityValidationContext; using IEntityMutator = store.IEntityMutator; using ReportDataRow = models.ReportDataRow;  public class ReportDataRowEntityHelper < T > :  EntityHelper<T> where T : ReportDataRow { private readonly IEntityMutator mutator ;
 
 public ReportDataRowEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
