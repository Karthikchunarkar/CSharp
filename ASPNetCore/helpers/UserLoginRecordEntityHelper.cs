namespace helpers ;
 using models; using repository.jpa; using store;  public class UserLoginRecordEntityHelper < T > :  EntityHelper<T> where T : UserLoginRecord { private readonly IEntityMutator mutator ;
