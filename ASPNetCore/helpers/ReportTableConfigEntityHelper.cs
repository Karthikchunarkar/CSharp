namespace helpers ;
 using d3e.core; using helpers; using models; using store;  public class ReportTableConfigEntityHelper < T > :  ReportBaseConfigEntityHelper<T> where T : ReportTableConfig { public ReportTableConfigEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
