namespace helpers ;
 using d3e.core; using helpers; using models; using store;  public class ReportNamedConditionFilterEntityHelper < T > :  ReportFilterEntityHelper<T> where T : ReportNamedConditionFilter { public ReportNamedConditionFilterEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
