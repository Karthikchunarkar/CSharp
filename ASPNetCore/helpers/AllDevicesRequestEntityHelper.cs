namespace helpers ;
 using models; using store;  public class AllDevicesRequestEntityHelper < T > :  EntityHelper<T> where T : AllDevicesRequest { private readonly IEntityMutator mutator ;
