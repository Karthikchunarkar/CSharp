namespace helpers ;
 using helpers; using models; using repository.jpa; using store;  public class ReportConfigEntityHelper < T > :  EntityHelper<T> where T : ReportConfig { private readonly IEntityMutator mutator ;
