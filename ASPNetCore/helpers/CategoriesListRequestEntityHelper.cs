namespace helpers ;
 using models; using store;  public class CategoriesListRequestEntityHelper < T > :  EntityHelper<T> where T : CategoriesListRequest { private readonly IEntityMutator mutator ;
 
 public CategoriesListRequestEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
