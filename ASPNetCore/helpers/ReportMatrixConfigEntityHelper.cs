namespace helpers ;
 using d3e.core; using helpers; using models; using store;  public class ReportMatrixConfigEntityHelper < T > :  ReportBaseConfigEntityHelper<T> where T : ReportMatrixConfig { public ReportMatrixConfigEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
