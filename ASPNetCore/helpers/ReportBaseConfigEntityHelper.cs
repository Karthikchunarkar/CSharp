namespace helpers ;
 using d3e.core; using models; using repository.jpa; using store;  public class ReportBaseConfigEntityHelper < T > :  EntityHelper<T> where T : ReportBaseConfig { private readonly IEntityMutator mutator ;
