namespace helpers ;
 using d3e.core; using helpers; using models; using store;  public class ReportWaterfallChartConfigEntityHelper < T > :  ReportBaseConfigEntityHelper<T> where T : ReportWaterfallChartConfig { public ReportWaterfallChartConfigEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
