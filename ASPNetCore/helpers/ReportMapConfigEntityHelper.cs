namespace helpers ;
 using classes; using d3e.core; using helpers; using models; using store;  public class ReportMapConfigEntityHelper < T > :  ReportBaseConfigEntityHelper<T> where T : ReportMapConfig { public ReportMapConfigEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
