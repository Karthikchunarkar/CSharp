namespace helpers ;
 using helpers; using models; using repository.jpa; using store;  public class ReportEntityHelper < T > :  EntityHelper<T> where T : Report { private readonly IEntityMutator mutator ;
