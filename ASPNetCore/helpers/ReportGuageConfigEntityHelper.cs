namespace helpers ;
 using d3e.core; using helpers; using models; using store;  public class ReportGuageConfigEntityHelper < T > :  ReportBaseConfigEntityHelper<T> where T : ReportGuageConfig { public ReportGuageConfigEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
