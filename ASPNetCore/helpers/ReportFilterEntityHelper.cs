namespace helpers ;
 using d3e.core; using models; using repository.jpa; using store;  public class ReportFilterEntityHelper < T > :  EntityHelper<T> where T : ReportFilter { private readonly IEntityMutator mutator ;
