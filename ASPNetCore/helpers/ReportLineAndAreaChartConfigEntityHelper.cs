namespace helpers ;
 using classes; using d3e.core; using helpers; using models; using store;  public class ReportLineAndAreaChartConfigEntityHelper < T > :  ReportBaseConfigEntityHelper<T> where T : ReportLineAndAreaChartConfig { public ReportLineAndAreaChartConfigEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
