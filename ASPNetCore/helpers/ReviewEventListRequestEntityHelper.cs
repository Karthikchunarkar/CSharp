namespace helpers ;
 using models; using store;  public class ReviewEventListRequestEntityHelper < T > :  EntityHelper<T> where T : ReviewEventListRequest { private readonly IEntityMutator mutator ;
 
 public ReviewEventListRequestEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
