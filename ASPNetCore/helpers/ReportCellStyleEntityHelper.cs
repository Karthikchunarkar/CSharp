namespace helpers ;
 using d3e.core; using models; using store;  public class ReportCellStyleEntityHelper < T > :  EntityHelper<T> where T : ReportCellStyle { private readonly IEntityMutator mutator ;
