namespace helpers ;
 using d3e.core; using helpers; using models; using store;  public class ReportMultiRowCardConfigEntityHelper < T > :  ReportBaseConfigEntityHelper<T> where T : ReportMultiRowCardConfig { public ReportMultiRowCardConfigEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
