namespace helpers ;
 using models; using store;  public class EventsListRequestEntityHelper < T > :  EntityHelper<T> where T : EventsListRequest { private readonly IEntityMutator mutator ;
 
 public EventsListRequestEntityHelper (  IEntityMutator mutator ) {
  mutator=mutator;
 }
