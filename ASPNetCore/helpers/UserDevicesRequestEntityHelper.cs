namespace helpers ;
 using models; using store;  public class UserDevicesRequestEntityHelper < T > :  EntityHelper<T> where T : UserDevicesRequest { private readonly IEntityMutator mutator ;
