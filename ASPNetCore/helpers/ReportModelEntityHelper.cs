namespace helpers ;
 using helpers; using models; using store;  public class ReportModelEntityHelper < T > :  EntityHelper<T> where T : ReportModel { private readonly IEntityMutator mutator ;
