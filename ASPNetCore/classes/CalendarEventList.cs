namespace classes ;
 using classes; using d3e.core; using java.util; using lists; using models; using store;  public class CalendarEventList :  DBObject { public static int _STATUS = 0 ;
 ...
 public CalendarEventList (  int count, List < string > errors, List < Event > items, ResultStatus status ) {
 this.Count = count ;
 ...
 public int _typeIdx (  ) {
 return SchemaConstants.CalendarEventList ;
 }
 public String _type (  ) {
