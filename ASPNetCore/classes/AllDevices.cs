namespace classes ;
 using classes; using d3e.core; using java.util; using lists; using models; using store;  public class AllDevices :  DBObject { public static int _STATUS = 0 ;
 ...
 public AllDevices (  List < string > errors, List < UserDevice > items, ResultStatus status ) {
 ...
 public int _typeIdx (  ) {
 return SchemaConstants.AllDevices ;
 }
 public String _type (  ) {
 return "AllDevices" ;
 }
