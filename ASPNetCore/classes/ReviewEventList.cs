namespace classes ;
 using classes; using d3e.core; using java.util; using lists; using models; using store;  public class ReviewEventList :  DBObject { public static int _STATUS = 0 ;
 ...
 public ReviewEventList (  ) {
 }
 public ReviewEventList (  int count, List < string > errors, List < Event > items, ResultStatus status ) {
 this.Count = count ;
 ...
 public int _typeIdx (  ) {
 return SchemaConstants.ReviewEventList ;
 }
 public String _type (  ) {
